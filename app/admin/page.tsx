      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
        {cards.map((card) => {
          ...
          return (
            <div
              key={card.title}
              className="bg-card-bg border border-border-color rounded-xl p-5 flex flex-col justify-between gap-4 shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300"
            >
