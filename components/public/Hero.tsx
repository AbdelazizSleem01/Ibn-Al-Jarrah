    ...
    <section className="relative overflow-hidden pt-16 pb-20 md:pt-24 md:pb-28 border-b border-border-color/30 transition-colors duration-300">
      ...
      <div className=" max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-5 flex justify-center order-1 md:order-2 animate-fade-in [animation-delay:150ms]">
          <div className="relative w-full max-w-[320px] md:max-w-[420px] md:-translate-y-8 aspect-square rounded-2xl overflow-hidden border border-border-color shadow-2xl bg-card-bg group gold-glow transition-all duration-700 ease-out hover:scale-[1.02] hover:shadow-[0_20px_50px_rgba(212,175,55,0.2)]">
